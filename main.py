...
class ImageProcessingStudio(ctk.CTk):
    ...
    def build_sidebar(self):
        ...
        # These buttons are still available if needed
        ctk.CTkButton(
            side,
            text="🔢  Show Pixel Matrix",
        ...
        ctk.CTkLabel(
            side,
            text=(
                "Tip: Open an image → choose a filter → "
                "Apply → Pixel Matrix and Kernel will "
    ...
    def build_viewer(self):
        ...
        self.pixel_matrix_label = ctk.CTkLabel(
            analysis_frame,
            text="Pixel matrix will appear here",
            justify="left",
            anchor="w",
            font=("Consolas", 11)
        )

        self.pixel_matrix_label.grid(
            row=1,
            column=0,
            padx=15,
            pady=(0, 15),
        ...
        # Kernel display
        self.kernel_label = ctk.CTkLabel(
            analysis_frame,
            text="Kernel will appear here",
            justify="left",
            anchor="w",
            font=("Consolas", 11)
        )

        self.kernel_label.grid(
            row=1,
            column=1,
            padx=15,
            pady=(0, 15),
    ...
    def on_filter_change(self, _value):
        ...
        # Filter is applied only when Apply Filter is pressed.
        pass
    ...
    def apply_filter(self):
        ...
        try:
            ...
            # Automatically update pixel matrix and kernel
            self.update_analysis()
    ...
    def update_analysis(self):
        ...
        if self.processed is None:
            ...
            self.pixel_matrix_label.configure(
                text="Pixel matrix will appear here"
            )

            self.kernel_label.configure(
                text="Kernel will appear here"
            )
    ...
    def save_output(self):
        ...
        self.status.configure(
            text=f"Output saved: {OUTPUT_FILE}"
        )
    ...
    def reset_image(self):
        ...
        # Automatically update analysis
        self.update_analysis()

        self.auto_save_output()

        self.status.configure(
            text="Reset to original image."
        )
    ...
    def show_pixel_matrix(self):
        ...
        if self.processed is None:
            ...
            messagebox.showwarning(
                "No image",
                "Please open/process an image first."
            )
